...
// RecordReviewRepo 保存人工 Gate 产生的不可变审核结论。source_step_run_id 是
...
type RecordReviewRepo interface {
	...
	FindApprovedRecordSetByStepRun(ctx context.Context, stepRunID string) (*model.ApprovedRecordSet, bool, error)
